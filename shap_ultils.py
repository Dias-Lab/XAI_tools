...
def get_shap(model, X, original_df_labels, target_label, model_name, link=shap.links.logit, multilabel=False):
    ...
    plot_path=out_prefix+'_beeswarm.png'
    plt.savefig(plot_path, dpi=400, bbox_inches = "tight")
...
def get_shap_interactions(model, X, original_df_labels, target_label, model_name, pert = 'tree_path_dependent', scaling_factor=8000, smoothing_factor=2, cor_threshold=0.80):
